...
void main()
{
    ...
    // the reason for an odd layout like this is that normally we'd use a 2D 256 * Y layout (to maximize locality of access), but that is slower than Y * 256 on AMD 7900GRE
